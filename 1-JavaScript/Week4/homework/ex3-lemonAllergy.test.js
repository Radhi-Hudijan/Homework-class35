...
// ! Function under test
function sanitizeFruitBasket(fruitsPurchased, unwantedFruit) {
  const sanitizedBasket = fruitsPurchased.filter(
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should not modify the original `fruitBasket` array', () => {
    ...
    const passOriginalArray = sanitizeFruitBasket(fruitBasket, 'lemon');
